...
import 'package:my_first_app/quiz/quiz_state.dart';
import 'package:my_first_app/services/firestore.dart';
import 'package:my_first_app/services/models.dart';
import 'package:my_first_app/shared/loading.dart';
import 'package:my_first_app/shared/progress_bar.dart';
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Center(child: Text(correct ? 'Good Job!' : 'Wrong')),
              Center(
                child: Text(
                  opt.detail,
